...
export default function Coins({isDialog = false}) {
    return(
        <div className={`bg-transparent border border-[#F8C935] border-dashed rounded-md inline-flex align-middle mx-1 flex-col items-start justify-center px-4 py-2 relative gap-1 ${isDialog && '!px-1.5 !py-0.5 !w-fit inline-block  align-middle h-[2.8em]'}`}>
